...
% RUN WITH: (Linux)
% python3 -m clingo res/asp_encoding/trip_id.asp res/output/arrival_departure.asp res/output/encoded_time_table.asp res/asp_encoding/calendar_dates.asp res/pendolarismo/fatti_pendolarismo.asp src/asp_scripts/train_types.asp res/asp_encoding/previous_stations.asp src/asp_scripts/optimizations/number_of_trains.asp --stats=2 --quiet=1 --time-limit=300 | grep -E "assign_trip_train|allowed_next_station|salta|new_station" | tr ' ' '\n' | sed 's/$/./' > res/output/ottimizzazione_number.asp
